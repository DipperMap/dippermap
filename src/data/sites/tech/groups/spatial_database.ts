...
export const spatialDatabase: IGroup = {
  ...
  children: [{
    ...
    "name": "PostGIS",
    "en_name": "PostGIS",
    "description": "A spatial database extender for PostgreSQL, allowing geographic objects to be stored, queried, and processed.",
    "en_description": "A spatial database extender for PostgreSQL, allowing geographic objects to be stored, queried, and processed.",
    ...
    "name": "SpatiaLite",
    "en_name": "SpatiaLite",
    "description": "A spatial extension for SQLite, enabling spatial support for geographic data.",
    "en_description": "A spatial extension for SQLite, enabling spatial support for geographic data.",
